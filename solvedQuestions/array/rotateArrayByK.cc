...
inline void solve() {
    ...
    //splitting array to two parts and reversing
    reverseArray(arr, n, 0, n - k - 1);  // reversing from 0 to n-k-1
    reverseArray(arr, n, n - k, n - 1);  // splitting from n-k to n-1

    reverseArray(arr, n, 0, n - 1);  //reverse full array
