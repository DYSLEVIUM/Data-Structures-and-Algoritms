...
/*
    In this algorithm, we divide the array into two sublist, i.e., ordered list and unordered list.
    We traverse through the unordered list and find the position it would be in the ordered list and the we insert it there
