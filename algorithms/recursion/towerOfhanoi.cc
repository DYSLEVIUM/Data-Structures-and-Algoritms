...
// https://www.geeksforgeeks.org/c-program-for-tower-of-hanoi/#:~:text=Tower%20of%20Hanoi%20is%20a,be%20moved%20at%20a%20time.
void towerOfHanoi(ll n, ll source, ll helper, ll destination) {
    if (n == 1) {
